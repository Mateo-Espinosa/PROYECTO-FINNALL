      ...
      <div>
        <cerrarSesion/>
          ...
          <v-main class="fondo-pagin" style="height: 100%;">
            ...
            <div>
              <v-headline class="titulo-favoritos">Mi carrito de compras</v-headline>
            </div>
        <v-row>
          <v-col
          v-for="(juego, index) 
          ...
          >
            ...
            >
              ...
              <p class="title-jue">{{ juego.Price }}</p>
              <v-card-actions>
                <v-spacer />
                <v-btn
                class="boton-cerrar"
                variant="tonal"
                color="white"
                title="Eliminar juego de carrito de compras"
            ...
            variant="tonal"
            color="white"
            title="Comprar juego de favoritos"
            @click="comprar"
...
export default {
  ...
  mounted() {
  document.title = 'CARRO DE COMPRAS';  //Nombre de la pagina
},
components: {
  cerrarSesion
},
  ...
  methods: {
    ...
    url(ruta){
      ...
      //Eliminar los juegos que estan como favoritos
  ...
  created() {
    ...
    if (favoritos) {
      ...
      this.favoritos = JSON.parse(localStorage.getItem('carrito') || '[]');
    }
  },
}
</script>
